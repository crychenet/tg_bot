...
dp.include_routers(profile_router, start_router, help_router, log_water_router)
...
async def main():
    ...
    set_up_user_calories_and_water_data_task = asyncio.create_task(set_up_user_calories_and_water_data(1))
